  <body class="bg-warning-subtle">
    <h1 class="text-center"> La historia de Pauny </h1>
    <div class="container">
      <div class ="card-body bg-warning mb-2 rounded border-primary">
            <p>
